...
init = function() {
	...
	*/
	...
	/*
		fontSize: (fullWidth * 18) / 1920,
		height: (fullWidth * 70) / 1920,
		top: - ((fullWidth * 70) / 1920),
	*/	
	$("#navbar .box").css({
...
setMainHeaderImg = function() {
	...
	txt.css({
		paddingTop: fullHeight - img.outerHeight()
	})
}
...
/*
// SHOW TOP NAV IS HOVER OF THE TOP OF THE PAGE AT HOME STATE
